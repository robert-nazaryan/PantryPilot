...
export interface RenameShoppingListPayload {
  listId: number;
  currentName: string;
  newName: string;
}

export interface DeleteShoppingListPayload {
  listId: number;
  listName: string;
  itemCount: number;
}
...
export type ProposedAction =
  ...
  | (ProposedActionBase & { type: "RENAME_SHOPPING_LIST"; payload: RenameShoppingListPayload })
  | (ProposedActionBase & { type: "DELETE_SHOPPING_LIST"; payload: DeleteShoppingListPayload })
  ...
  | (ProposedActionBase & { type: "UPDATE_RECIPE"; payload: UpdateRecipePayload })
